#这是kaggle上上一个参赛选手的代码，用xgboost实现超市销售量的预测
import pandas as pd
import numpy as np
...
def build_features(features, data):
    ...
    data.StoreType.replace(mappings, inplace=True)#fillna是从无到有，replace是从一个值到另外一个值
...
train = pd.read_csv("/home/wangtuntun/IJCAI/Rossman/Data/train.csv", parse_dates=[2], dtype=types)
test = pd.read_csv("/home/wangtuntun/IJCAI/Rossman/Data/test.csv", parse_dates=[3], dtype=types)
